...
function ulx.slap( calling_ply, target_plys, dmg )
	...
	for i=1, #target_plys do
		...
		if v:IsFrozen() then
			ULib.tsayError( calling_ply, v:Nick() .. " está congelado!", true )
		else
			ULib.slap( v, dmg )
	...
	ulx.fancyLogAdmin( calling_ply, "#A deu tapa em #T com #i de dano", affected_plys, dmg )
end
...
function ulx.stripweapons( calling_ply, target_plys )
	...
	ulx.fancyLogAdmin( calling_ply, "#A desarmou #T", target_plys )
end
