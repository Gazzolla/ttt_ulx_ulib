...
function ulx.psay( calling_ply, target_ply, message )
	ulx.fancyLog( { target_ply, calling_ply }, "(MENSAGEM PRIVADA de #P) para #P: #P" .. calling_ply, target_ply, message )
end
